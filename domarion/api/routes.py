...
from domarion.api.compare_routes import (
    build_compare_analyses as _build_compare_analyses,
)
from domarion.api.compare_routes import (
...
def list_listings(
    ...
    has_balcony: Annotated[bool | None, Query(description="Require balcony flag")] = None,
    has_terrace: Annotated[bool | None, Query(description="Require terrace flag")] = None,
    has_garden: Annotated[bool | None, Query(description="Require garden flag")] = None,
    has_elevator: Annotated[bool | None, Query(description="Require elevator flag")] = None,
    parking_type: Annotated[str | None, Query(description="Parking type code")] = None,
    heating_type: Annotated[str | None, Query(description="Heating type code")] = None,
    ...
    min_building_year: Annotated[int | None, Query(ge=1800, le=2100)] = None,
    max_building_year: Annotated[int | None, Query(ge=1800, le=2100)] = None,
    ...
    min_developer_confidence_score: Annotated[int | None, Query(ge=0, le=100)] = None,
    min_developer_completed_projects: Annotated[int | None, Query(ge=0)] = None,
    min_developer_active_projects: Annotated[int | None, Query(ge=0)] = None,
    require_developer_reputation: Annotated[bool, Query()] = False,
