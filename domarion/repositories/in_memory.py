...
class InMemoryRealEstateRepository:
    ...
    def __init__(self) -> None:
        self._areas = {
            ...
            "kobierzyce-kobierzyce": AreaStatistics(
                area_id="kobierzyce-kobierzyce",
                name="Kobierzyce",
                city="Kobierzyce",
                median_price_per_m2=9900,
                average_price_per_m2=10180,
                active_listings=68,
                new_listings_30d=9,
                removed_listings_30d=7,
                average_days_on_market=101,
                price_change_90d_pct=0.8,
                supply_change_90d_pct=7.2,
            ),
            "wysoka-wysoka": AreaStatistics(
                area_id="wysoka-wysoka",
                name="Wysoka",
                city="Wysoka",
                median_price_per_m2=12600,
                average_price_per_m2=12950,
                active_listings=73,
                new_listings_30d=13,
                removed_listings_30d=9,
                average_days_on_market=82,
                price_change_90d_pct=1.7,
                supply_change_90d_pct=4.6,
            ),
            "bielany-wroclawskie-bielany-wroclawskie": AreaStatistics(
                area_id="bielany-wroclawskie-bielany-wroclawskie",
                name="Bielany Wrocławskie",
                city="Bielany Wrocławskie",
                median_price_per_m2=11300,
                average_price_per_m2=11620,
                active_listings=54,
                new_listings_30d=8,
                removed_listings_30d=6,
                average_days_on_market=90,
                price_change_90d_pct=1.2,
                supply_change_90d_pct=5.9,
            ),
            "olawa-olawa": AreaStatistics(
                area_id="olawa-olawa",
                name="Oława",
                city="Oława",
                median_price_per_m2=9300,
                average_price_per_m2=9580,
                active_listings=118,
                new_listings_30d=17,
                removed_listings_30d=14,
                average_days_on_market=88,
                price_change_90d_pct=0.6,
                supply_change_90d_pct=3.8,
            ),
        }
        ...
        self._listings = {
            ...
            "kob-001": Listing(
                id="kob-001",
                title="3 pokoje w centrum Kobierzyc",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/kob-001",
                city="Kobierzyce",
                district="Kobierzyce",
                area_id="kobierzyce-kobierzyce",
                municipality="Kobierzyce",
                address="Wrocławska, Kobierzyce",
                market_type="secondary",
                price=545000,
                currency="PLN",
                area_m2=55.4,
                ...
                nearest_stop_m=620,
                nearest_school_m=760,
                nearest_major_road_m=710,
            ...
            "kob-002": Listing(
                id="kob-002",
                title="2 pokoje po remoncie, Kobierzyce",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/kob-002",
                city="Kobierzyce",
                district="Kobierzyce",
                area_id="kobierzyce-kobierzyce",
                municipality="Kobierzyce",
                address="Spółdzielcza, Kobierzyce",
                market_type="secondary",
                price=475000,
                currency="PLN",
                area_m2=47.0,
                ...
                lat=50.9704,
                lon=16.9385,
                distance_to_center_km=16.7,
                nearest_stop_m=680,
                nearest_school_m=810,
                nearest_major_road_m=760,
                nearest_industrial_zone_m=2550,
                parks_within_1km=1,
                schools_within_1km=1,
                planned_investments_within_2km=0,
                data_quality_score=74,
            ...
            "wys-001": Listing(
                id="wys-001",
                title="3 pokoje blisko granicy Wrocławia, Wysoka",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/wys-001",
                city="Wysoka",
                district="Wysoka",
                area_id="wysoka-wysoka",
                municipality="Wysoka",
                address="Radosna, Wysoka",
                market_type="secondary",
                price=748000,
                currency="PLN",
                area_m2=58.7,
                ...
                lat=51.0337,
                lon=17.0264,
                distance_to_center_km=8.7,
                nearest_stop_m=390,
                nearest_school_m=910,
                nearest_major_road_m=540,
                nearest_industrial_zone_m=2600,
                parks_within_1km=1,
                schools_within_1km=1,
                planned_investments_within_2km=1,
            ...
            "wys-002": Listing(
                id="wys-002",
                title="2 pokoje z balkonem, Wysoka",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/wys-002",
                city="Wysoka",
                district="Wysoka",
                area_id="wysoka-wysoka",
                municipality="Wysoka",
                address="Brzozowa, Wysoka",
                market_type="secondary",
                price=589000,
                currency="PLN",
                area_m2=46.8,
                ...
                nearest_stop_m=450,
                nearest_school_m=960,
                nearest_major_road_m=500,
                nearest_industrial_zone_m=2750,
                parks_within_1km=1,
                schools_within_1km=1,
                planned_investments_within_2km=1,
                data_quality_score=76,
            ...
            "bie-001": Listing(
                id="bie-001",
                title="3 pokoje, Bielany Wrocławskie",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/bie-001",
                city="Bielany Wrocławskie",
                district="Bielany Wrocławskie",
                area_id="bielany-wroclawskie-bielany-wroclawskie",
                municipality="Bielany Wrocławskie",
                address="Czekoladowa, Bielany Wrocławskie",
                market_type="secondary",
                price=679000,
                currency="PLN",
                area_m2=59.6,
                ...
                lat=51.0357,
                lon=16.9675,
                distance_to_center_km=10.7,
                nearest_stop_m=540,
                nearest_school_m=1190,
            ...
            "bie-002": Listing(
                id="bie-002",
                title="2 pokoje przy usługach, Bielany",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/bie-002",
                city="Bielany Wrocławskie",
                district="Bielany Wrocławskie",
                area_id="bielany-wroclawskie-bielany-wroclawskie",
                municipality="Bielany Wrocławskie",
                address="Kolejowa, Bielany Wrocławskie",
                market_type="secondary",
                price=525000,
                currency="PLN",
                area_m2=46.3,
                ...
                lat=51.0334,
                lon=16.9644,
                distance_to_center_km=11.0,
                nearest_stop_m=610,
                nearest_school_m=1240,
                nearest_major_road_m=390,
                nearest_industrial_zone_m=1750,
                parks_within_1km=1,
                schools_within_1km=0,
                planned_investments_within_2km=0,
            ...
            "ola-001": Listing(
                id="ola-001",
                title="3 pokoje blisko centrum Oławy",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/ola-001",
                city="Oława",
                district="Oława",
                area_id="olawa-olawa",
                municipality="Oława",
                address="Chrobrego, Oława",
                market_type="secondary",
                price=558000,
                currency="PLN",
                area_m2=59.9,
                ...
                lat=50.9457,
                lon=17.2926,
                distance_to_center_km=27.4,
                nearest_stop_m=460,
                nearest_school_m=640,
            ...
            "ola-002": Listing(
                id="ola-002",
                title="2 pokoje po remoncie, Oława",
                source_name="Partner Suburban Seed",
                source_url="https://example.com/listings/ola-002",
                city="Oława",
                district="Oława",
                area_id="olawa-olawa",
                municipality="Oława",
                ...
                nearest_stop_m=500,
                nearest_school_m=680,
                nearest_major_road_m=590,
                nearest_industrial_zone_m=2300,
                parks_within_1km=2,
                schools_within_1km=1,
                planned_investments_within_2km=0,
                data_quality_score=75,
