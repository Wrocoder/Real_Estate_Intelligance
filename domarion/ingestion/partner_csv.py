...
def normalize_partner_row(
    ...
    listing = Listing(
        ...
        investment_name=_optional_str(row, "investment_name"),
        primary_market_project_id=_optional_str(row, "primary_market_project_id"),
        price=price,
        ...
        nearest_major_road_m=_optional_int(row, "nearest_major_road_m"),
        nearest_industrial_zone_m=_optional_int(row, "nearest_industrial_zone_m"),
        parks_within_1km=_optional_int(row, "parks_within_1km"),
        schools_within_1km=_optional_int(row, "schools_within_1km"),
        planned_investments_within_2km=_optional_int(row, "planned_investments_within_2km"),
