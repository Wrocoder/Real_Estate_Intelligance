...
- [x] Добавить growth factors: transport, schools, parks, hospitals, retail, offices, universities, population/jobs growth.
...
- [x] Добавить moderation/dispute workflow для developer reputation signals.
...
- [x] Подключить listing AI assistant на listing detail page.
- [x] Подключить user-submitted draft AI assistant на link-to-report page.
- [x] Добавить compare-A-vs-B AI response template.
- [x] Подключить compare-A-vs-B AI verdict на compare page.
...
- [x] Добавить data quality acceptance tests для geocoding, dedup и source freshness.
- [x] Добавить contract tests для paid artifacts и report metadata.
- [x] Добавить frontend smoke tests для search, map, reports, admin и payments.
...
- [x] Добавить agency CRM-light UI на account page: clients, notes, shortlists and share preview.
