...
Цель: добавить в WartoMetr слой оценки застройщиков, чтобы покупатель видел не только цену и район, но и кто строил объект, чем застройщик силен, какие есть риски и на каких источниках основаны выводы.
